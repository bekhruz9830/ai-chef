    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('No items yet', style: AppTextStyles.title.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
          const SizedBox(height: 8),
          Text(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(category, style: AppTextStyles.subtitle.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
                    const Spacer(),
                    Text(
                      '${items.length} items',
