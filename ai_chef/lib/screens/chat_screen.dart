...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _syncLanguage() {
    ...
    if (_lastLang != loc.lang) {
      _lastLang = loc.lang;
      _gemini.setLanguage(loc.lang);
    }
  }

  static const String _welcomeMessageKey = '__welcome__';

  void _addWelcomeMessage() {
    _messages.add(ChatMessage(
      text: _welcomeMessageKey,
      isUser: false,
      time: DateTime.now(),
    ));
  }
  ...
  Future<void> _sendMessage(String text) async {
    ...
    try {
      ...
      setState(() {
        _messages.add(ChatMessage(
          text: response.isNotEmpty ? response : loc.t('chat_error_response'),
          isUser: false,
          time: DateTime.now(),
        ));
      });
  ...
  Widget _buildMessage(ChatMessage message) {
    ...
    final displayText = (!isUser && message.text == _welcomeMessageKey)
        ? loc.t('chat_welcome')
        : message.text;
    return Padding(
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: AppTextStyles.body.copyWith(
                  color: isUser ? Theme.of(context).colorScheme.onPrimary : Theme.of(context).textTheme.bodyLarge?.color,
                ),
              ),
            ),
          ),
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: Provider.of<LocalizationService>(context).t('ask_chef_placeholder'),
                  filled: true,
