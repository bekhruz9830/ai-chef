...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  Future<void> _removeFromFavorites(Recipe recipe) async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(loc.t('removed_from_favorites')),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(loc.t('saved_recipes')),
        actions: [
            ...
            Padding(
              ...
              child: Center(
                child: Container(
                  ...
                  child: Text(
                    '${_recipes.length} ${loc.t('recipes_count')}',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(loc.t('no_saved_yet'), style: AppTextStyles.title.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
  ...
  Widget _buildChip(String text) {
    return Container(
      ...
      child: Text(text, style: AppTextStyles.caption.copyWith(color: Theme.of(context).textTheme.bodyMedium?.color)),
    );
  }
