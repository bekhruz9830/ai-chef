        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Icon(
              ...
              color: _recipe.isFavorite ? Colors.red : const Color(0xFF1A1A1A),
              size: 22,
            ),
          ),
        ),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildStatItem(
                  '⏱', '${_recipe.prepTime + _recipe.cookTime}', Provider.of<LocalizationService>(context).t('min_total')),
              _buildStatItem('🔪', '${_recipe.prepTime}', Provider.of<LocalizationService>(context).t('min_prep')),
              _buildStatItem('🍳', '${_recipe.cookTime}', Provider.of<LocalizationService>(context).t('min_cook')),
              _buildStatItem('📊', _recipe.difficulty, Provider.of<LocalizationService>(context).t('level')),
            ],
          ),
          const SizedBox(height: 16),
          Row(
            children: [
              Text('${Provider.of<LocalizationService>(context).t('servings')}:', style: AppTextStyles.body.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
              const Spacer(),
              IconButton(
  ...
  Widget _buildStatItem(String emoji, String value, String label) {
    return Column(
      children: [
        ...
        Text(value, style: AppTextStyles.subtitle.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
        Text(label, style: AppTextStyles.caption.copyWith(color: Theme.of(context).textTheme.bodyMedium?.color)),
      ],
    );
  }
  ...
  Widget _buildNutrition() {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(Provider.of<LocalizationService>(context).t('nutrition_per_serving'), style: AppTextStyles.subtitle.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
          const SizedBox(height: 12),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(
                child: Text(lines[index], style: AppTextStyles.body.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
              ),
            ],
          ),
        );
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(Provider.of<LocalizationService>(context).t('similar_recipes'), style: AppTextStyles.subtitle.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
            const SizedBox(height: 12),
            Expanded(
        ...
        child: Column(
          ...
          children: [
            OutlinedButton.icon(
              ...
              label: Text(_loadingSimilar ? Provider.of<LocalizationService>(context).t('loading') : Provider.of<LocalizationService>(context).t('similar_recipes')),
            ...
            ElevatedButton(
              ...
              child: Text('${Provider.of<LocalizationService>(context).t('start_cooking')} 👨‍🍳'),
            ),
          ],
        ),
      ),
