...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildTipsSection() {
    final tips = [
      {'emoji': '🧄', 'tip': 'Store garlic in a cool, dark place for up to 6 months'},
      {'emoji': '🥩', 'tip': 'Let meat rest 5 minutes after cooking for juicier results'},
      {'emoji': '🧂', 'tip': 'Salt pasta water generously - it should taste like the sea'},
      {'emoji': '🔪', 'tip': 'A sharp knife is safer than a dull one'},
    ];
